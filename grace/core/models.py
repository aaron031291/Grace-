...
class Memory(Base):
    ...
    memory_type: Mapped[str] = mapped_column(
        String(50), default="fusion", index=True
    )  # lightning, fusion, librarian
...
class MemoryEmbedding(Base):
    ...
    similarity_threshold: Mapped[Optional[float]] = (
        mapped_column()
    )  # Custom threshold for this embedding
