...
class MultiOSKernel:
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "platform": self.runtime_snapshot.platform if self.runtime_snapshot else "unknown",
            "python_version": self.runtime_snapshot.python_version[:10] if self.runtime_snapshot else "unknown",
