...
class MemorySnapshotManager:
    ...
    def create_snapshot(self, description: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            snapshot_id = f"memory_snapshot_{datetime.utcnow().strftime('%Y%m%d_%H%M%S')}"
    ...
    def _collect_lightning_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'entries_summary': entries[:100]  # Store summary to avoid large snapshots
            }
    ...
    def delete_snapshot(self, snapshot_id: str) -> bool:
        ...
        try:
            ...
            conn = sqlite3.connect(self.db_path)
            cursor = conn.execute("DELETE FROM memory_snapshots WHERE snapshot_id = ?", (snapshot_id,))
