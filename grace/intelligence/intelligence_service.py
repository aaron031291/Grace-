...
class IntelligenceService:
    ...
    def _default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "ensembler": {"type": "stack", "meta_model": "lr-meta@1.0.2"},
            "inference": {"timeout_ms": 800, "batch_max": 64},
        }
    ...
    def _process_request_async(self, req_id: str, task_req: dict):
        ...
        try:
            ...
            self._emit_event(
                "INTEL_INFER_STARTED", {"plan_id": plan["plan_id"], "req_id": req_id}
            )
            ...
            # Complete request
            self._emit_event(
                "INTEL_INFER_COMPLETED", {"req_id": req_id, "result": result}
            )
            ...
            self._complete_request(
                req_id, {"req_id": req_id, "status": "error", "error": str(e)}
            )
    ...
    def _requires_governance_check(self, plan: dict) -> bool:
        ...
        return (
            route.get("canary_pct", 0) > 25  # High canary percentage
            or len(route.get("models", [])) > 5  # Many models
            or plan.get("policy", {}).get("min_confidence", 1.0)
            < 0.7  # Low confidence threshold
        )
    ...
    def _generate_explanations(self, result: dict, plan: dict) -> dict:
        ...
        return {"method": "auto", "feature_importance": {}, "local_explanations": {}}
