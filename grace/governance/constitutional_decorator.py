...
from .constitutional_validator import ConstitutionalValidator, ConstitutionalValidationResult
...
class ConstitutionalCheckError(Exception):
    ...
    def __init__(self, message: str, violations: list, validation_result: ConstitutionalValidationResult):
...
def constitutional_check(policy: str = "default", 
    ...
    def decorator(func: Callable):
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            validation_result = await validator.validate_against_constitution(action, context)
            ...
            if not validation_result.is_valid:
                ...
                await audit_logger.log_governance_action(
                    ...
                    data={
                        ...
                        "severity": "critical" if any(v.severity == "critical" for v in validation_result.violations) else "major"
                    },
            ...
            try:
                ...
                if isinstance(result, dict):
                    ...
                    if validation_result.violations:
                        result["governance"]["violations"] = [vars(v) for v in validation_result.violations]
                ...
                await audit_logger.log_governance_action(
                    ...
                    data={
                        ...
                        "has_governance_metadata": isinstance(result, dict) and "governance" in result
                    },
                    transparency_level=transparency_level
                )
...
def trust_middleware(min_trust_score: float = 0.75,
                    trust_sources: Optional[list] = None):
    """
        ...
        async def wrapper(*args, **kwargs):
            ...
            if trust_score < min_trust_score:
                raise ConstitutionalCheckError(
                    ...
                    [{"type": "trust_violation", "score": trust_score, "required": min_trust_score}],
                    None
                )
...
class ContradictionService:
    ...
    async def _check_contradiction(self, action1: Dict, action2: Dict) -> Optional[Dict]:
        """Check if two actions contradict each other."""
        # Simple contradiction detection logic
        # In practice, this would be more sophisticated
        
        if (action1.get("type") == "allow" and action2.get("type") == "deny" and
            action1.get("resource") == action2.get("resource")):
            return {
...
def uniform_envelope_builder(envelope_type: str = "governance_response",
            ...
            try:
                ...
                if include_audit_trail:
                    envelope["audit_trail"] = {
                        ...
                        "constitutional_checks": getattr(result, "governance", {}).get("constitutional_compliance", True),
                        "trust_score": kwargs.get("_trust_score"),
                        "policy_applied": getattr(result, "governance", {}).get("policy_applied")
                    }
