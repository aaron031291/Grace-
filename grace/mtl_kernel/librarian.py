...
from ..contracts.dto_common import MemoryEntry, W5HIndex
...
class Librarian:
    ...
    def __init__(self, memory_service: MemoryService, llm_kernel: Optional[LLMKernel] = None):
        self.memory_service = memory_service
        self.w5h_indexer = W5HIndexer()
        self.llm_kernel = llm_kernel or LLMKernel()
    
    def ingest(self, content: str, content_type: str = "text/plain", metadata: Optional[Dict] = None) -> str:
    ...
    def search_and_rank(self, query: str, limit: int = 10) -> List[MemoryEntry]:
        ...
        results = self.memory_service.query(query, limit=limit * 2)  # Get more for reranking
