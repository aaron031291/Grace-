...
class SnapshotManager:
    ...
    def _collect_active_query_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if row:
                ...
                return {"strategy": "hybrid", "batch_size": 128}
        finally:
            conn.close()
    ...
    def _collect_augmentation_config(self) -> Dict[str, Any]:
        ...
        return {
            "text": {"back_translate": ["en-de", "en-es"], "synonym_swap_prob": 0.1},
            "image": {"mixup": {"alpha": 0.4}, "rand_crop_prob": 0.2},
        }
    ...
    def delete_snapshot(self, snapshot_id: str) -> bool:
        ...
        try:
            cursor = conn.cursor()
            cursor.execute(
                "DELETE FROM learning_snapshots WHERE snapshot_id = ?", (snapshot_id,)
            )
