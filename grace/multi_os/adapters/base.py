...
class PkgAdapter(ABC):
    ...
    @abstractmethod
    async def install_package(self, name: str, version: Optional[str] = None, 
                             manager: str = "auto") -> bool:
        """Install a package."""
        pass
...
class GPUAdapter(ABC):
    ...
    @abstractmethod
    async def allocate_gpu(self, requirements: Dict[str, Any]) -> Optional[Dict[str, Any]]:
