...
class EventBus:
    ...
    async def publish(self, event_type: str, payload: Dict[str, Any], 
        ...
        failed_count = sum(1 for result in delivery_results if isinstance(result, Exception))
        ...
        success_rate = (len(delivery_results) - failed_count) / max(1, len(delivery_results))
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        status = {
            "eventbus": {
                ...
                "failed_deliveries": self.failed_deliveries,
                "success_rate": (self.event_count - self.failed_deliveries) / max(1, self.event_count),
