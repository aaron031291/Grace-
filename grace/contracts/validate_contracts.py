...
def main():
    ...
    test_cases = [
        ...
        (
            "experience.json",
            "Experience",
            ["experience_id", "source", "task", "context", "signals", "timestamp"],
        ),
        (
            "insight.json",
            "Insight",
            ["insight_id", "type", "scope", "evidence", "confidence", "timestamp"],
        ),
        (
            "specialist_report.json",
            "SpecialistReport",
            ["report_id", "specialist", "task", "candidates", "timestamp", "version"],
        ),
        (
            ...
            if missing_fields:
                ...
                if schema_name == "AdaptationPlan":
                    ...
                    if "candidates" in example_data:
                        print(
                            f"   - Contains {len(example_data['candidates'])} candidates"
                        )
    ...
    schema_files = ["ml_schemas.json", "ml_events.json", "ml_api.json"]
