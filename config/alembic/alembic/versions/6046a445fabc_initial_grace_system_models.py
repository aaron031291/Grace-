...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_background_tasks_priority"),
        "background_tasks",
        ["priority"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_tasks_scheduled_at", "background_tasks", ["scheduled_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_tasks_task_type", "background_tasks", ["task_type"], unique=False
    )
    op.create_index(
        "ix_tasks_worker_id", "background_tasks", ["worker_id"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_memories_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_memories")),
    )
    op.create_index(
        op.f("ix_memories_category"), "memories", ["category"], unique=False
    )
    op.create_index(
        "ix_memories_content_hash", "memories", ["content_hash"], unique=False
    )
    ...
    op.create_index(
        "ix_memories_memory_type", "memories", ["memory_type"], unique=False
    )
    op.create_index(
        op.f("ix_memories_priority"), "memories", ["priority"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_memories_user_id_key", "memories", ["user_id", "key"], unique=False
    )
    op.create_table(
        "sessions",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        "ix_sessions_last_accessed", "sessions", ["last_accessed"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_system_operations_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_system_operations")),
    )
    op.create_index(
        "ix_operations_created_at", "system_operations", ["created_at"], unique=False
    )
    op.create_index(
        "ix_operations_resource",
        "system_operations",
    ...
    op.create_index(
        "ix_operations_user_id_created_at",
        "system_operations",
        ["user_id", "created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_system_operations_operation_type"),
        "system_operations",
        ["operation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_system_operations_resource_id"),
        "system_operations",
        ["resource_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_system_operations_resource_type"),
        "system_operations",
        ["resource_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_system_operations_status"),
        "system_operations",
        ["status"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_system_operations_resource_type"), table_name="system_operations"
    )
    op.drop_index(
        op.f("ix_system_operations_resource_id"), table_name="system_operations"
    )
    op.drop_index(
        op.f("ix_system_operations_operation_type"), table_name="system_operations"
    )
