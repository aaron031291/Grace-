...
from grace.core.auth import auth_service, UserCreate, UserResponse, Token
...
from grace.core.dependencies import CurrentUser
...
async def refresh_token(
    ...
    try:
        ...
        await repos.sessions.update(
            user_session.id, {"token_id": new_token_data["token_id"]}
        )
...
async def logout(
    ...
    user_sessions = await repos.sessions.get_user_sessions(
