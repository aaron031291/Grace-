...
from sqlalchemy import (
    ...
    Boolean, ForeignKey, Table, Index
)
...
session_users_table = Table(
    'session_users', Base.metadata,
    Column('session_id', UUID(as_uuid=True), ForeignKey('sessions.id'), primary_key=True),
    Column('user_id', String, primary_key=True)
)

knowledge_entry_tags_table = Table(
    'knowledge_entry_tags', Base.metadata,
    Column('knowledge_entry_id', UUID(as_uuid=True), ForeignKey('knowledge_entries.id'), primary_key=True),
...
class Message(Base, TimestampMixin):
    ...
    fragments = relationship("Fragment", back_populates="message", cascade="all, delete-orphan")
