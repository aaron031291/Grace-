...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_collab_sessions_owner", "collab_sessions", ["owner_user_id"], unique=False
    )
    op.create_index(
        op.f("ix_collab_sessions_owner_user_id"),
        "collab_sessions",
        ["owner_user_id"],
        unique=False,
    )
    op.create_index(
        "ix_collab_sessions_public", "collab_sessions", ["is_public"], unique=False
    )
    op.create_index(
        "ix_collab_sessions_status", "collab_sessions", ["status"], unique=False
    )
    op.create_table(
        "event_logs",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_event_logs_event_type"), "event_logs", ["event_type"], unique=False
    )
    op.create_index(
        op.f("ix_event_logs_session_id"), "event_logs", ["session_id"], unique=False
    )
    op.create_index(
        "ix_event_logs_timestamp", "event_logs", ["timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_event_logs_trace_id"), "event_logs", ["trace_id"], unique=False
    )
    op.create_index(
        "ix_event_logs_type_source",
        "event_logs",
        ["event_type", "source"],
        unique=False,
    )
    op.create_index(
        op.f("ix_event_logs_user_id"), "event_logs", ["user_id"], unique=False
    )
    op.create_index(
        "ix_event_logs_user_session",
        "event_logs",
        ["user_id", "session_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_notifications_expires", "notifications", ["expires_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_sessions_user_status", "sessions", ["user_id", "status"], unique=False
    )
    op.create_table(
        "tasks",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_tasks_status_priority", "tasks", ["status", "priority"], unique=False
    )
    op.create_index(op.f("ix_tasks_task_type"), "tasks", ["task_type"], unique=False)
    op.create_index(
        "ix_tasks_type_status", "tasks", ["task_type", "status"], unique=False
    )
    ...
    op.create_index(
        "ix_knowledge_entries_created",
        "knowledge_entries",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        "ix_knowledge_entries_hash", "knowledge_entries", ["content_hash"], unique=False
    )
    op.create_index(
        "ix_knowledge_entries_trust", "knowledge_entries", ["trust_score"], unique=False
    )
    op.create_index(
        "ix_knowledge_entries_user", "knowledge_entries", ["user_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_fragments_content_hash"), "fragments", ["content_hash"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_knowledge_entries_content_hash"), table_name="knowledge_entries"
    )
    ...
    op.drop_index(
        op.f("ix_collab_sessions_owner_user_id"), table_name="collab_sessions"
    )
