...
class SnapshotManager:
    ...
    async def create_snapshot(self, state: Optional[Dict[str, Any]] = None) -> MLTSnapshot:
    ...
    async def rollback_to_snapshot(self, snapshot_id: str, verify_hash: bool = True) -> bool:
