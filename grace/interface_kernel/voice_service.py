...
class VoiceService:
    ...
    def _initialize_voice_components(self) -> bool:
        ...
        if not VOICE_AVAILABLE:
            logger.warning("Voice dependencies not available. Install speech_recognition and pyttsx3.")
            return False
    ...
    async def _handle_voice_input(self, text: str):
        ...
        try:
            ...
            await self._speak("I'm sorry, I encountered an error processing your request.")
    ...
    async def _handle_voice_commands(self, text: str) -> bool:
        ...
        if "stop voice" in text_lower or "disable voice" in text_lower or "voice off" in text_lower:
            await self._stop_voice_mode()
            return True
