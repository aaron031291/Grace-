...
# Metrics
REQUEST_COUNT = Counter('grace_requests_total', 'Total requests', ['method', 'endpoint', 'status_code'])
REQUEST_DURATION = Histogram('grace_request_duration_seconds', 'Request duration', ['method', 'endpoint'])
