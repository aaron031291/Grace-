...
class AuthenticatedWebSocket:
    ...
    async def authenticate(self, required_scopes: list = None, required_roles: list = None):
        """
        ...
        logger.info(f"WebSocket authenticated: user={self.user_id}, scopes={self.scopes}")
...
async def authenticate_websocket(websocket: WebSocket, 
                                ...
                                required_roles: list = None) -> AuthenticatedWebSocket:
    """
