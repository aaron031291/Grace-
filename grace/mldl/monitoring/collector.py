...
class MonitoringCollector:
    ...
    async def record_metric(self, model_key: str, version: str, metric_type: str,
        ...
        try:
            ...
            # Check SLOs
            await self._check_slos(model_key, version, metric_name, metric_value, deployment_id)
            
        except Exception as e:
            logger.error(f"Failed to record metric: {e}")
    
    async def get_metrics(self, model_key: Optional[str] = None,
