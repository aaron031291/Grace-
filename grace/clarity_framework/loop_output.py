...
class ReasoningChain:
    ...
    def add_step(self, description: str, input_data: Dict[str, Any], 
    ...
    def _update_total_confidence(self):
        ...
        weighted_sum = sum(step.confidence * weight 
                          for step, weight in zip(self.steps, weights))
...
class GraceLoopOutput:
    ...
    def __post_init__(self):
        ...
        if not hasattr(self.reasoning_chain, 'chain_id') or not self.reasoning_chain.chain_id:
    ...
    def add_reasoning_step(self, description: str, input_data: Dict[str, Any],
                          output_data: Dict[str, Any], confidence: float,
                          processing_time_ms: Optional[float] = None) -> str:
    ...
    def set_validation_result(self, passed: bool, details: Optional[Dict[str, Any]] = None):
