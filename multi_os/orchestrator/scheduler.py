...
class Scheduler:
    ...
    async def place(self, exec_task: Dict[str, Any], hosts: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(f"Task {exec_task.get('task_id')} placed on {selected_host['host_id']} with score {best_score:.3f}")
    ...
    def _filter_eligible_hosts(self, exec_task: Dict[str, Any], hosts: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    async def _score_host(self, host: Dict[str, Any], exec_task: Dict[str, Any]) -> float:
        """
    ...
    def _score_capability_fit(self, host: Dict[str, Any], exec_task: Dict[str, Any]) -> float:
    ...
    def _score_success_rate(self, host: Dict[str, Any], exec_task: Dict[str, Any]) -> float:
    ...
    def _calculate_penalties(self, host: Dict[str, Any], exec_task: Dict[str, Any]) -> float:
    ...
    def _infer_capabilities(self, exec_task: Dict[str, Any], constraints: Dict[str, Any]) -> set:
    ...
    def _explain_placement(self, host: Dict[str, Any], exec_task: Dict[str, Any], score: float) -> Dict[str, Any]:
        ...
        return {
            ...
            "requirements_met": {
                ...
                "gpu_required": exec_task.get("constraints", {}).get("gpu_required", False),
                "capabilities_needed": list(self._infer_capabilities(exec_task, exec_task.get("constraints", {})))
            }
        }
