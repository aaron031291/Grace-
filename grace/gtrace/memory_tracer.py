...
class MemoryTracer:
    ...
    def trace_file_upload(self, file_path: str, user_id: str, 
                         session_id: Optional[str] = None,
                         parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_text_ingestion(self, title: str, content_length: int,
    ...
    def trace_memory_search(self, query: str, user_id: Optional[str] = None,
                           session_id: Optional[str] = None,
                           parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_embedding_generation(self, text_chunks: int, model: str,
                                 parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_vector_storage(self, vector_count: int, dimension: int,
                           parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_text_extraction(self, file_path: str, extractor_type: str,
                            parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_text_chunking(self, content_length: int, chunker_type: str,
                          parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_fragment_creation(self, fragment_id: str, content_type: str,
                              parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def trace_copilot_operation(self, operation_type: str, context: Dict[str, Any],
                              parent_context: Optional[TraceContext] = None) -> TraceSpan:
    ...
    def add_file_metadata(self, span: TraceSpan, file_size: int, 
    ...
    def add_processing_result(self, span: TraceSpan, chunks_created: int,
                            fragments_created: int, embedding_dimension: int) -> None:
        ...
        span.log("processing_completed", {
            "chunks": chunks_created,
            "fragments": fragments_created,
            "embedding_dim": embedding_dimension
        })
    
    def add_search_result(self, span: TraceSpan, results_found: int,
                         search_time_ms: float, similarity_threshold: float) -> None:
        ...
        span.log("search_completed", {
            "results": results_found,
            "duration_ms": search_time_ms,
            "threshold": similarity_threshold
        })
    
    def add_error_context(self, span: TraceSpan, error: Exception,
                         operation_stage: str, context: Optional[Dict[str, Any]] = None) -> None:
    ...
    def get_memory_operation_stats(self) -> Dict[str, Any]:
        ...
        memory_spans = [s for s in finished_spans 
