...
async def safe_operation(
    data: Dict[str, Any], rationale: str = "Safe data processing"
) -> Dict[str, Any]:
    """
...
async def trusted_operation(
    data: Dict[str, Any], rationale: str = "Trusted computation"
) -> Dict[str, Any]:
    """
    ...
    return {"result": "computed", "audit_id": audit_id, "trust_verified": True}
...
class CompliantService:
    ...
    async def public_method(
        self, data: Dict[str, Any], rationale: str = "Public service operation"
    ) -> Dict[str, Any]:
...
async def main():
    ...
    result1 = await safe_operation(
        {"test": "data"}, rationale="Testing governance compliance"
    )
    ...
    result3 = await service.public_method(
        {"service": "test"}, rationale="Public service usage"
    )
