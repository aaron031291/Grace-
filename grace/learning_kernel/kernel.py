...
class LearningKernel:
    ...
    def __init__(self, db_path: Optional[str] = None, event_bus=None, governance_engine=None):
        # Database setup
        if db_path is None:
    ...
    def apply_augmentation(self, dataset_id: str, version: str, spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def generate_quality_report(self, dataset_id: str, version: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def send_labeling_experience(self, label_throughput: float, agreement: float,
    ...
    async def send_active_learning_experience(self, query_gain_f1: float, strategy: str,
                                            batch_size: int, coverage: float,
                                            dataset_id: Optional[str] = None) -> str:
    ...
    async def send_quality_experience(self, bias_delta: float, leakage_flags: int,
                                    ds_drift_psi: float, coverage: float,
    ...
    async def submit_dataset_publication(self, dataset_id: str, version: str,
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        legacy_stats = {
            ...
            "success_rate": sum(1 for o in self.outcomes if o.success) / max(1, len(self.outcomes)),
        ...
        return {
            ...
            "legacy": legacy_stats,
            "capabilities": [
                "dataset_management", "active_learning", "weak_supervision",
                "human_in_the_loop", "data_augmentation", "quality_evaluation",
                "feature_store", "snapshot_rollback", "mlt_integration",
    ...
    def record_outcome(self, outcome_type: str, context: Dict, result: Dict, 
