...
class ImmutableLogs:
    ...
    async def log_policy_change(
        self, change_data: Dict[str, Any], transparency_level: str = "public"
    ) -> str:
        """Log a policy change."""
        return await self._create_log_entry(
    ...
    async def log_threshold_change(
        self,
    ...
    async def log_constitutional_event(
        self, event_data: Dict[str, Any], transparency_level: str = "public"
    ) -> str:
    ...
    async def log_experience(
        self, experience: Experience, transparency_level: str = "governance_internal"
    ) -> str:
    ...
    async def _create_log_entry(
        self, category: str, data: Dict[str, Any], transparency_level: str
    ) -> str:
        ...
        logger.info(
            f"Logged {category} entry: {entry_id} (level: {transparency_level})"
        )
    ...
    def get_audit_statistics(self) -> Dict[str, Any]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            return {
                ...
                "last_entry_hash": self.log_chain[-1].chain_hash
                if self.log_chain
                else None,
            }
