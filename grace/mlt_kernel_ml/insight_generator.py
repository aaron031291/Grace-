...
class InsightGenerator:
    ...
    async def generate_insights(self, experiences: List[Experience]) -> List[Insight]:
        ...
        try:
            ...
            logger.info(f"Generated {len(insights)} insights from {len(experiences)} experiences")
            return insights
    ...
    async def _analyze_performance(self, experiences: List[Experience]) -> Optional[Insight]:
    ...
    async def _analyze_fairness(self, experiences: List[Experience]) -> Optional[Insight]:
    ...
    async def _analyze_calibration(self, experiences: List[Experience]) -> Optional[Insight]:
        ...
        if avg_calibration < 0.85 or min_calibration < 0.7:
            ...
            return Insight(
                ...
                evidence={
                    "before": None,
                    "after": {"avg_calibration": avg_calibration, "min_calibration": min_calibration},
    ...
    async def _analyze_stability(self, experiences: List[Experience]) -> Optional[Insight]:
    ...
    async def _analyze_governance_alignment(self, experiences: List[Experience]) -> Optional[Insight]:
        ...
        if avg_compliance < 0.9 or min_compliance < 0.8:
            ...
            return Insight(
                ...
                evidence={
                    "before": None,
                    "after": {"avg_compliance": avg_compliance, "min_compliance": min_compliance},
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        by_type = {}
        for insight_type in InsightType:
            by_type[insight_type.value] = len([ins for ins in self.insights if ins.type == insight_type])
