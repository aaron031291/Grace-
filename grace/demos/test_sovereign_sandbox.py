...
# Test imports
from grace.governance.sandbox_manager import SandboxManager, ExperimentType, ResourceQuota
...
from grace.governance.human_feedback import HumanFeedbackInterface, FeedbackType, FeedbackScore
...
class SovereignSandboxTestSuite:
    ...
    async def test_consensus_engine(self) -> bool:
        ...
        try:
            ...
            logger.info(f"✓ Persona reliability scores: {len(reliability_scores)} personas")
    ...
    async def test_human_feedback(self) -> bool:
        ...
        try:
            ...
            logger.info(f"✓ Reviewer dashboard: {dashboard['total_reviews_completed']} reviews")
            
            # Test system metrics
            metrics = feedback_interface.get_system_feedback_metrics()
            assert metrics["completed_reviews"] >= 1
            logger.info(f"✓ System metrics: {metrics['completed_reviews']} completed reviews")
    ...
    async def test_grace_experiment_cycle(self) -> bool:
        ...
        try:
            ...
            logger.info(f"✓ Sovereignty report: {report['sovereignty_metrics']['total_sovereign_decisions']} decisions")
    ...
    async def test_orb_dashboard(self) -> bool:
        ...
        try:
            ...
            for section in required_sections:
                assert hasattr(dashboard_data, section), f"Missing dashboard section: {section}"
            ...
            logger.info(f"✓ Grace autonomy level: {autonomy_metrics['current_autonomy_level']:.2f}")
    ...
    async def test_meta_learning(self) -> bool:
        ...
        try:
            ...
            from grace.governance.human_feedback import HumanFeedback, FeedbackType, FeedbackScore
