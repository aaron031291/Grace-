...
class HITLQueue:
    ...
    def create_task(self, task: Dict[str, Any]) -> str:
        ...
        if assign_strategy not in valid_assignments:
            raise ValueError(
                f"Invalid assignment strategy. Must be one of: {valid_assignments}"
            )
    ...
    def get_queue_for_annotator(
        self, annotator_id: str, limit: int = 10
    ) -> List[Dict[str, Any]]:
    ...
    def _get_labeled_items(
        self, task_id: str, annotator_id: Optional[str] = None
    ) -> List[str]:
        ...
        try:
            ...
            return {
                ...
                "progress": {
                    ...
                    "total": total_items,
                    "completion_rate": labeled_count / total_items
                    if total_items > 0
                    else 0.0,
                },
                "quality": {
    ...
    def get_annotator_stats(self, annotator_id: str, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "quality_score": round(
                    (row["avg_agreement"] or 0.0) * gold_accuracy, 3
                ),
            }
        finally:
            conn.close()
