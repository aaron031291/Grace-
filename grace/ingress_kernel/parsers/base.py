    ...
    async def parse(self, raw_event: RawEvent) -> ParseResult:
        ...
        try:
            ...
            data = {
                ...
                "raw_html": content[:1000] if len(content) > 1000 else content  # Truncate
            }
...
class ParserFactory:
    ...
    @classmethod
    def create_parser(cls, parser_type: str, options: Optional[Dict[str, Any]] = None) -> BaseParser:
