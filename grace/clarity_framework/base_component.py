...
class BaseComponent(ABC):
    ...
    def get_error_info(self) -> Dict[str, Any]:
        ...
        return {"error_count": self._error_count, "last_error": self._last_error}
    ...
    async def safe_activate(self) -> bool:
        ...
        try:
            ...
            if success:
                self.update_status(
                    ComponentStatus.ACTIVE, "Activation completed successfully"
                )
                return True
            else:
    ...
    async def safe_deactivate(self) -> bool:
        ...
        try:
            ...
            if success:
                self.update_status(
                    ComponentStatus.INACTIVE, "Deactivation completed successfully"
                )
                return True
            else:
