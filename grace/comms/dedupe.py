...
class MessageDeduplicator:
    ...
    def _generate_content_hash(self, envelope: GraceMessageEnvelope) -> str:
        ...
        try:
            ...
            hash_data = {
                ...
                'created_at_minute': envelope.created_at.replace(second=0, microsecond=0).isoformat()
            }
    ...
    async def is_duplicate(self, envelope: GraceMessageEnvelope, strict_mode: bool = False) -> bool:
        """Check if message is a duplicate within the configured time window."""
        try:
            self.stats['total_checked'] += 1
            
            # Generate appropriate hash
            message_hash = (self._generate_strict_hash(envelope) if strict_mode 
    ...
    def _add_to_cache(self, message_hash: str, message_id: str, created_at: datetime):
        ...
        try:
            ...
            if len(self.memory_cache) >= self.max_memory_entries:
                ...
                oldest_hash = min(self.memory_cache.keys(), 
    ...
    async def cleanup_expired(self) -> int:
        ...
        try:
            ...
            if total_deleted > 0:
                logger.info(f"Cleaned up {total_deleted} expired dedupe entries "
    ...
    def get_duplicate_info(self, envelope: GraceMessageEnvelope, strict_mode: bool = False) -> Optional[Dict[str, Any]]:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cursor = conn.execute("""
                ...
                WHERE created_at >= ?
            """, ((datetime.utcnow() - timedelta(minutes=self.window_minutes)).isoformat(),))
