...
class MemoryService:
    ...
    def query(self, query_text: str, filters: Optional[Dict] = None, limit: int = 10) -> List[MemoryEntry]:
    ...
    def get_entries_by_filters(self, filters: Dict) -> List[MemoryEntry]:
        ...
        for entry in self.store.entries.values():
            ...
            if "content_type" in filters and entry.content_type != filters["content_type"]:
                match = False
