    ...
    def check_security_config(self, config_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            for control in self.required_security_controls:
                if control in config_data or self._find_control_variant(control, config_data):
                    found_controls += 1
                else:
                    missing_controls.append(control)
            
            result["missing_controls"] = missing_controls
            result["security_score"] = found_controls / len(self.required_security_controls)
            ...
            result["compliant"] = len(critical_issues) == 0 and result["security_score"] >= 0.8
...
def main():
    ...
    if not security_files:
        ...
        print("📋 Security recommendations created at: policies/security_recommendations.yaml")
        return 1
