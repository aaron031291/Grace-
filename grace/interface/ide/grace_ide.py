...
class GraceIDE:
    ...
    def _initialize_block_registry(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "api_fetch": {
                ...
                "inputs": [
                    {"name": "url", "data_type": "string", "required": True, "default_value": "", "description": "API endpoint URL"},
                    {"name": "method", "data_type": "string", "required": True, "default_value": "GET", "description": "HTTP method"}
                ],
                "outputs": [
                    {"name": "data", "data_type": "any", "description": "Response data"},
                    {"name": "status_code", "data_type": "int", "description": "HTTP status code"}
                ]
            },
            ...
            "sentiment_analysis": {
                ...
                "inputs": [
                    {"name": "text_data", "data_type": "any", "required": True, "default_value": None, "description": "Text data for analysis"}
                ],
                "outputs": [
                    {"name": "sentiment_scores", "data_type": "dict", "description": "Sentiment scores"},
                    {"name": "classification", "data_type": "string", "description": "Overall sentiment"}
                ]
            },
            ...
            "data_filter": {
                ...
                "inputs": [
                    {"name": "data", "data_type": "any", "required": True, "default_value": None, "description": "Input data"},
                    {"name": "filter_condition", "data_type": "string", "required": True, "default_value": "", "description": "Filter condition"}
                ],
                "outputs": [
                    {"name": "filtered_data", "data_type": "any", "description": "Filtered data"}
                ]
            }
        }
    ...
    def add_block_to_flow(self, flow_id: str, block_type_id: str, position: Dict[str, float]) -> str:
