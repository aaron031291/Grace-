...
class WindowsAdapter(
    ProcessAdapter, FSAdapter, NetAdapter, PkgAdapter, SnapshotAdapter
):
    """
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        logger.info(
            f"Windows adapter initialized with {self.package_manager} package manager"
        )
    ...
    def _apply_appcontainer(
        self, command: List[str], constraints: Dict[str, Any]
    ) -> List[str]:
