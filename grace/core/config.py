...
class GraceSettings(BaseSettings):
    ...
    worker_queues: str = Field(default="ingestion,embeddings,media", env="WORKER_QUEUES")
    ...
    constitutional_enforcement: bool = Field(default=True, env="CONSTITUTIONAL_ENFORCEMENT")
...
def setup_environment():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('logs/grace.log') if os.path.exists('logs') else logging.StreamHandler()
        ]
    )
