...
class GraceComponentManifest:
    ...
    def __post_init__(self):
        ...
        if not self.registered_at and self.activation_state != ActivationState.UNREGISTERED:
    ...
    def set_activation_state(self, new_state: ActivationState, details: Optional[str] = None):
        ...
        elif old_state == ActivationState.ACTIVE and new_state != ActivationState.ACTIVE:
            self.deactivation_count += 1
    
    def add_capability(self, name: str, description: str, input_types: List[str],
                      output_types: List[str], confidence_level: float):
    ...
    def add_dependency(self, component_id: str, component_type: str,
                      required_capabilities: List[str], is_hard: bool = True,
                      fallback_strategy: Optional[str] = None):
    ...
    def can_activate(self) -> tuple[bool, str]:
        ...
        if self.activation_state in [ActivationState.ACTIVE, ActivationState.INITIALIZING]:
            return False, f"Component already active or initializing: {self.activation_state.value}"
