...
class FeatureStore:
    ...
    def build_view(
        self, dataset_id: str, version: str, format: str = "parquet"
    ) -> Dict[str, Any]:
        ...
        success = self._build_feature_view_process(
            dataset_id, version, view_uri, format
        )
    ...
    def _build_feature_view_process(
        self, dataset_id: str, version: str, view_uri: str, format: str
    ) -> bool:
    ...
    def validate_train_serve_parity(
        ...
        if view["build_status"] != "ready":
            return {
                "valid": False,
                "error": f"Feature view status: {view['build_status']}",
            }
    ...
    def create_feature_view_snapshot(
        self, dataset_id: str, version: str
    ) -> Dict[str, Any]:
