...
class MultiOSBridge:
    ...
    async def restart_host(self, host_id: str, reason: str = "resilience_healing") -> Dict[str, Any]:
        """
    ...
    async def reprovision_instance(
        ...
        try:
            ...
            logger.info(f"Requested instance reprovision for {instance_id}: {result['status']}")
            return result
    ...
    async def reload_snapshot(
        ...
        instance_id: str,
        snapshot_id: str,
        reason: str = "resilience_recovery"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(f"Requested snapshot reload for {instance_id}: {result['status']}")
            return result
    ...
    def get_infrastructure_history(self, limit: int = 100) -> list:
        ...
        return self.infrastructure_actions[-limit:] if limit else self.infrastructure_actions
