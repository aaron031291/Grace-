    ...
    def _register_legacy_routes(self):
        ...
        async def toggle_voice_mode():
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Voice toggle failed: {str(e)}")
        ...
        async def get_voice_status():
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Voice status failed: {str(e)}")
        ...
        async def get_health_alerts(resolved: Optional[bool] = None, hours: int = 24):
            ...
            try:
                alerts = self.health_dashboard.get_alerts(resolved=resolved, hours=hours)
                return {
                    "alerts": alerts,
                    "total": len(alerts)
                }
        ...
        async def get_component_health(component_name: str, hours: int = 24):
            ...
            try:
                history = self.health_dashboard.get_component_history(component_name, hours)
        ...
        async def start_health_monitoring():
            ...
            try:
                ...
                return {"message": "Health monitoring started", "monitoring_active": True}
            except Exception as e:
        ...
        async def stop_health_monitoring():
            ...
            try:
                ...
                return {"message": "Health monitoring stopped", "monitoring_active": False}
            except Exception as e:
        ...
        async def ingest_book(request: BookIngestionRequest):
            ...
            try:
                ...
                return BookIngestionResponse(
                    ...
                    title=result["title"],
                    message=result.get("processing_summary", {}).get("chapters_processed", 0)
                )
            except Exception as e:
        ...
        async def get_book_chapters(job_id: str):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Get chapters failed: {str(e)}")
        ...
        async def search_book_content(job_id: str, query: str, limit: int = 10):
            ...
            try:
                results = await self.book_ingestion.search_book_content(job_id, query, limit)
                return {
                    "job_id": job_id,
                    "query": query,
                    "results": results,
