...
from .scheduler.scheduler import Scheduler, LoopDefinition
...
class OrchestrationService:
    ...
    def _setup_routes(self):
        ...
        async def rollback_system(request: RollbackRequest, background_tasks: BackgroundTasks):
    ...
    async def start(self):
        ...
        try:
            ...
            # Register router
            router_component = ManagedComponent(
                "router",
                self.router
            )
            ...
            # Set startup order
            self.lifecycle_manager.set_startup_order([
                "scheduler", "router"
            ])
    ...
    def dispatch(self, loop_id: str, task: Dict[str, Any]) -> str:
        ...
        return asyncio.create_task(
            self.scheduler.dispatch_task(loop_id, task)
        )
    ...
    def export_snapshot(self) -> Dict[str, Any]:
        ...
        # Convert to async
        return asyncio.create_task(
            self.snapshot_manager.export_snapshot()
        )
    ...
    def rollback(self, to_snapshot: str) -> Dict[str, Any]:
        ...
        # Convert to async
        return asyncio.create_task(
            self.snapshot_manager.rollback(to_snapshot)
        )